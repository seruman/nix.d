...
local-package-checks := ".#checks.aarch64-darwin.bttf .#checks.aarch64-darwin.cloudflareCf .#checks.aarch64-darwin.gitHunks .#checks.aarch64-darwin.glimpseui .#checks.aarch64-darwin.sleeve .#checks.aarch64-darwin.teteye .#checks.aarch64-darwin.unfolder .#checks.aarch64-darwin.wb"
